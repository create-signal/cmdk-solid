        ...
        <Command.List>
          <div cmdk-framer-items="">
            ...
            <div cmdk-framer-right="">
              <Show when={value() === 'Button'}>
                <Button />
              </Show>
              <Show when={value() === 'Input'}>
                <Input />
              </Show>
              <Show when={value() === 'Badge'}>
                <Badge />
              </Show>
              <Show when={value() === 'Radio'}>
                <Radio />
              </Show>
              <Show when={value() === 'Avatar'}>
                <Avatar />
              </Show>
              <Show when={value() === 'Slider'}>
                <Slider />
              </Show>
              <Show when={value() === 'Container'}>
                <Container />
              </Show>
            </div>
          </div>
